    ...
    if (isset($_GET['id']) and !empty($_GET['id'])) {
        ...
        if (isset($_GET['confirmado']) and $_GET['confirmado']==1) {
            ...
            try {
                ...
                $pasta = '../../uploads/imoveis/'.$imovel->pasta.'/';
                ...
                if (file_exists($pasta)) {
                    ...
                    $delete = $pdo->prepare('DELETE FROM imovel WHERE id = :pId');
                ...
                array_push($erros,'Erro ao deletar o Imóvel no banco de dados: '.$e->getMessage());
            }
...
<body class="d-flex justify-content-center">
    ...
    <div class="col-6 my-5 bg-body-secondary rounded text-danger p-3">
        ...
        <?php } else { ?>
            ...
            <h5>Deseja mesmo excluir o Imóvel?</h5>
            <hr>
