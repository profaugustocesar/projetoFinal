    ...
    if (isset($_GET['id']) and !empty($_GET['id'])) {
        ...
        if (isset($_GET['confirmado']) and $_GET['confirmado']==1) {
            ...
            try {
                ...
                if (@unlink('../../uploads/icones/'.$tipoImovel->icone)) {
                
                    $delete = $pdo->prepare('DELETE FROM tipo_imovel WHERE id = :pId');
                    ...
                    array_push($erros,'Erro ao deletar o arquivo do Ícone');

                }

            } catch (PDOException $e) {
                array_push($erros,'Erro ao deletar o Tipo de Imóvel no banco de dados: '.$e->getMessage());
            }
...
<head>
    ...
    <title>Deletar Tipo de Imóvel</title>
...
<body class="d-flex justify-content-center">
    ...
    <div class="col-6 my-5 bg-body-secondary rounded text-danger p-3">
        ...
        <?php } else { ?>
            ...
            <h5>Deseja mesmo excluir o Tipo de Imóvel?</h5>
            <hr>
